...
function CheckForm()
{
	...
	{
		alert("Must be Filled Company Name?");
	...
	{
		alert("Must be Filled Contact Person?");
...
function kkform()
{
  if(document.seaidnmm.typ.value=="0")
  {
	  document.seaidnmm.action="searchinfo.asp";
  }
  else
  {
	  document.seaidnmm.action="sproduct.asp";
  }
}
